...
public class LoginController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//사용자가 useridm pass 파라미터를 전송 했다는 가정으로 개발
		...
		//			  서버 안에서 이루어 지는 작업으로 클라이언트 입장에서는 누가 응답을 생성했는지 알 수 없다
		...
		// 3. 2번 비교 사항이 true일 때 webapp/main.jsp로 forward(main.jsp)는 생성
		// 4. 2번 비교 사항이 false 일 때 webapp/login.jsp로 redirect
